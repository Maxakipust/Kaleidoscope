...
/// of arguments the function takes).
    class PrototypeAST {
        ...
        bool IsOperator;
        unsigned Precedence; //precedence if binary ip
...
static std::unique_ptr<PrototypeAST> ParsePrototype() {
    ...
    //verify the right number of names for operator
...
/// the function. This is used for mutable variables
...
Function *FunctionAST::codegen() {
    ...
    //if this is a operator, install it.
    if (P.isBinaryOp())
...
Value *IfExprAST::codegen() {
    ...
    //create blocks for the then and else cases. put "then" at the end of the function
